...
number_of_events_per_run = 8000  # Events for each of the 10 runs
...
integration_report_file = "Int_emissions-8000-4.csv"
generation_report_file = "Gen_emissions-8000-4.csv"
